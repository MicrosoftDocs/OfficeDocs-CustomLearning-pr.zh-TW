...
在 [產品] 類別中，"Office 365 基礎" 子類別已更新為 "Microsoft 365 基礎" 類別。 [Office 365 基礎] 類別中已停用的資產若已新增至自訂播放清單，仍然可供使用。
...
「Product\Microsoft 小組」子類別已使用下列資產進行更新。 
...
- 在 PowerPoint (new) 中，將手寫筆跡變更為圖案、文字或數學圖案
